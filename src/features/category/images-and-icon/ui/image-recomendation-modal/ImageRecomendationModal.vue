<template>
  <SModal v-model="props.value" width="640px" height="auto" @onClose="onClose">
    <p class="font-bold s-mb-5 font-size-24">
      {{ $t("lang-01eb9949-cc57-48b1-8ea3-554e39c1d8d9") }}
    </p>
    <p class="color-violet-600 s-mb-5">
      {{ $t("lang-8ea0acd3-e638-43b8-9ad0-ef49449d310c") }}
    </p>

    <div class="d-flex flex-row items-center gap-24 s-mb-4">
...
import { SModal } from "@tumarsoft/ogogo-ui";
